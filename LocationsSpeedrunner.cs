        ...
        public LocationsSpeedrunner() {
            Locations = new List<Location>
            {
                ...
                new Location
                {
                    ...
                    Type = Location.RandomizeType.Upgrade,
                    CanAccess = have => have.Contains("archaea_cave_chargejump"),
                    CanEscape = have => have.Contains("enable_run") || have.Contains("enable_charge_jump") ||
                        have.Contains("enable_dynamite") || have.Contains("enable_jump_double")
                },
                new Location
                {
                    Name = "drill",
                ...
                new Location
                {
                    ...
                    Type = Location.RandomizeType.Upgrade,
                    CanAccess = have => have.Contains("oldworld_cave_steampunch"),
                ...
                new Location
                {
                    ...
                    CanEscape = have => have.Contains("enable_dynamite") || have.Contains("enable_jump_double")
                },
                new Location
                {
                ...
                new Location
                {
                    ...
                    CanAccess = have => have.Contains("vectron_cave_generator_1") &&
                        ((have.Contains("enable_charge_jump") && (have.Contains("punch") || have.Contains("drill"))) ||
                        have.Contains("enable_dynamite")),
                },
